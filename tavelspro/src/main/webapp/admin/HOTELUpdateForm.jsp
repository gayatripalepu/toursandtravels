...
{
	data.HOTELDAOImpl euser = new data.HOTELDAOImpl(request);
	euser.edit();
	response.sendRedirect("HotelListForm.jsp");
}
else
{
data.HOTELDAOImpl user = new data.HOTELDAOImpl();
int hid = Integer.parseInt(request.getParameter("hid"));
HOTEL h = user.getHOTEL(hid);
...
<input type="text" name="txthotelid" id="txthotelid"  value="<%=h.getHOTELID()%>" disabled>
<input type="hidden" name="txthotelid" id="txthotelid" value="<%=h.getHOTELID()%>" autocomplete="off">
<input type="hidden" name="txtimgpath" id="txtimgpath" value="<%=h.getIMGPATH()%>" autocomplete="off">
<small></small>
</div>
<div class="form-field">
<label for="hotelname">Hotelname:</label>
<input type="text" name="txthotelname" id="txthotelname" value="<%=h.getHOTELNAME()%>" autocomplete="off" required>
<small></small>
</div>
<div class="form-field">
<label for="hoteltype">Hoteltype:</label>
<select  name="txthoteltype" id="txthoteltype">
<option value="<%=h.getHOTELTYPE()%>"><%=h.getHOTELTYPE()%></option>
...
<input type="text" name="txtaddress" id="txtaddress"  value="<%=h.getADDRESS()%>" autocomplete="off" required>
<small></small>
</div><div class="form-field">
<label for="cost">Cost:</label>
<input type="text" name="txtcost" id="txtcost"  value="<%=h.getCOST()%>" autocomplete="off" required>
<small></small>
