...
java.util.List<business.TPACKAGE> l  = T.listTPACKAGE();
%>  
...
<div class="row" style="width:100%">
  ...
  <a href="TPACKAGEListForm.jsp" class="active">Packages</a>
...
<h3 style="float:left;"><a href="TPACKAGEForm.jsp" class="button">Insert</a></h3>
<% if(l != null){ %>
  <table id='result' class='display'>
    ...
    <% for(business.TPACKAGE object : l ) {%> 
      <tr>
        ...
        <td><%=object.getTRANSPORT()%></td>
        <td><%=object.getCOST()%>
      
	<td><a  href="#" onclick="return show('<%=object.getPID()%>');"><i class="fa fa-trash-o" style="font-size:24px"></i></a>
	<a href="EditPackageForm.jsp?pid=<%=object.getPID()%>"><i class='fa fa-edit' style='font-size:24px'></i></a>
      </tr>
...
console.log(value);
window.location.href ="http://localhost:8083/tavelspro/admin/deletepack.jsp?pid="+value;
