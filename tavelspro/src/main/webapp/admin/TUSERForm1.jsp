...
<input type="text" name="txtusername" id="txtusername"  autocomplete="off" required>
<small></small>
</div><div class="form-field">
<label for="phonenumber">Phonenumber:</label>
<input type="text" name="txtphonenumber" id="txtphonenumber"  autocomplete="off" required>
<small></small>
</div><div class="form-field">
...
<select name="txtgender" id="txtgender" class="form-control"> <option selected>Male</option><option>Female</option></select> <small></small> </div>
<div class="form-field">
<label for="aadhaar">Aadhaar:</label>
<input type="text" name="txtaadhaar" id="txtaadhaar"  autocomplete="off" required>
<small></small>
</div><div class="form-field">
...
<input type="text" name="txtans" id="txtans"  autocomplete="off" required>
<small></small>
</div>
