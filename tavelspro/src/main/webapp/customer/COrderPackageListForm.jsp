...
java.util.List<business.ORDERPACKAGES> l  = o.listORDERPACKAGES(username);
%>  
...
<% if(l != null){ %>
  <table id='result' class='display'>
	...
	<td>
	<a href="OrderCancel.jsp?orderid=<%=object.getORDERID()%>" class="button" style="padding:5px;">Cancel</a>&nbsp;
	<a href="FeedbackForm.jsp?pid=<%=object.getPACKAGEID()%>" class="button" style="padding:5px;">FeedBack</a>
