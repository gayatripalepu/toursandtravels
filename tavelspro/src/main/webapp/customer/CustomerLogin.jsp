...
<div class="row" style="width:100%">
  ...
  <a href="/tavelspro/admin/AdminLogin.jsp"><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;AdminLogin</a>
      ...
      <div class="formcontainer" style="width:100%;height:100%;">
        ...
        <form id="signup" class="form" method="POST">         
            ...
            <div class="form-field">
                ...
                <a href="ForgotPasswod.jsp">ForgotPassword</a>&nbsp;&nbsp;NewUser?&nbsp;<a href="/tavelspro/register.jsp">SignUP</a>
