...
{
	data.FEEDBACKTBDAOImpl fid = new FEEDBACKTBDAOImpl(request);
	fid.insert();
...
<div class="column">
    <div class="card">
      <h3 style="background-color:dodgerblue;color:white;padding: 10px 10px;">Feedback Form</h3>
     
<div class="formcontainer" style="width:100%;">
<form id="tpackagefrom" class="form" style="width:100%" method="post">
<input type="hidden" id="txtfeedid" name="txtfeedid" value="10" >
<input type="hidden" id="txtusername" name="txtusername" value="<%=session.getAttribute("username")%>" >
<input type="hidden" id="txtpid" name="txtpid" value="<%=request.getParameter("pid")%>" >
<div class="form-field">
<label for="comments">Feedback</label>
<textarea  name="txtcomments" id="txtcomments" autocomplete="off" rows="4" cols="50" required>
</textarea>
